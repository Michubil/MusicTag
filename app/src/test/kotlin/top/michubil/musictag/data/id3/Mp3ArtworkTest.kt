...
class Mp3ArtworkTest {
    ...
    @Test
    fun externalMp3SampleDecodesWithoutChangingSource() {
        val path = System.getProperty("musicTag.mp3Sample")
        assumeTrue("Supply -Mp3SamplePath to validate an external source file", !path.isNullOrBlank())
        ...
        try {
            ...
            assertArrayEquals("Source MP3 must remain unchanged", before, digest(source))
        }
    }
